...
import { apiRequest, queryClient, toAbsoluteUrl, clearCsrfToken } from '@/lib/queryClient';
import { format, parseISO, isToday, isFuture, isSameMonth } from 'date-fns';
import BarberBookingCard, { type BarberBooking as Booking } from '@/components/BarberBookingCard';
      ...
      <header className="sticky top-0 z-40 bg-background/90 backdrop-blur-md border-b px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate('/profile')} data-testid="button-avatar">
